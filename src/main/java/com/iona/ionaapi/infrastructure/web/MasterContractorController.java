...
import com.iona.ionaapi.infrastructure.dto.CreateMasterContractorRequest;
import com.iona.ionaapi.infrastructure.dto.MasterContractorResponse;
import com.iona.ionaapi.infrastructure.dto.PagedMasterContractorResponse;
import com.iona.ionaapi.infrastructure.dto.UpdateMasterContractorRequest;
...
public class MasterContractorController {
     ...
     *      -d '{"name": "Bouygues Construction", "type": "PRIVATE", "siret": "39478149800034", "address": "3 Avenue du Centre, 75001 Paris"}'
     */
    @PostMapping
     ...
     *      -H "Content-Type: application/json" \
     *      -H "X-Tenant-ID: courtier-lacroix" \
     *      -d '{"name": "Bouygues Construction SA", "address": "1 Avenue Eugène Freyssinet, 78280 Guyancourt"}'
     */
    @PutMapping("/{id}")
